...
class Ucx(AutotoolsPackage, CudaPackage):
    ...
    version(
        "1.15.0",
        sha256="4b202087076bc1c98f9249144f0c277a8ea88ad4ca6f404f94baa9cb3aebda6d",
    )
    version(
        "1.14.1",
        sha256="baa0634cafb269a3112f626eb226bcd2ca8c9fcf0fec3b8e2a3553baad5f77aa",
    )
    version(
        "1.14.0",
        sha256="9bd95e2059de5dece9dddd049aacfca3d21bfca025748a6a0b1be4486e28afdd",
    )
    version(
        "1.13.1",
        sha256="efc37829b68e131d2acc82a3fd4334bfd611156a756837ffeb650ab9a9dd3828",
    )
    version(
        "1.13.0",
        sha256="8a3881f21fe2788113789f5bae1c8174e931f7542de0a934322a96ef354e5e3d",
    )

    # Retired
    version(
        "1.12.1",
        sha256="40b447c8e7da94a253f2828001b2d76021eb4ad39647107d433d62d61e18ae8e",
    )
    version(
        "1.12.0",
        sha256="93e994de2d1a4df32381ea92ba4c98a249010d1720eb0f6110dc72c9a7d25db6",
    )
    version(
        "1.11.2",
    ...
    variant(
        ...
        default=False,
        when="@1.11.0:",
        description="UCX Virtual Filesystem support",
    )
    ...
    def patch(self):
        if self.spec.satisfies("+rocm"):
            ...
            filter_file(
                "-L$with_rocm/hip/lib -L$with_rocm/lib",
                "$ROCM_LDFLAGS",
                "configure",
                string=True,
            )

...
class Gaussian(Package):
    ...
    def url_for_version(self, version):
        ris_mirror = "/storage2/fs1/RIS-Services/Active/compute2-private/spack/mirrors/gaussian"
        return "file://{0}/g{1}.tgz".format(ris_mirror, version)
    ...
    @run_after("install")
    def remove_world_permissions(self):
        # Recursively remove all permissions for 'others' (WORLD) from installed files
        chmod = which("chmod")
        chmod("-R", "o-rwx", self.g_root)
